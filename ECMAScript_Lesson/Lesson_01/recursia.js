// Например, вычисление степени: 2 в 10 = 2 в 9 × 2.
...
const result = exponentiation(4, 4); // 256
console.log(result);
...
// Всегда проверяйте данные, которые к вам пришли.
    if (!Array.isArray(formStructure)) return 'Wrong formstructure';
...
form = form +`<div class="field-wrapper">
